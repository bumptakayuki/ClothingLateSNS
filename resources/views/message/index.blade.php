                ...
                <div class="container">
                    ...
                    <div id="frame">
                        <div id="sidepanel">
                            <div id="profile">
                                <div class="wrap">
                                    <img id="profile-img" src="img/shop/cart-widget/02.jpg" class="online" alt="" />
                                    <p>エミリー</p>
                                    ...
                                    <li class="contact">
                                        <div class="wrap">
                                            ...
                                            <div class="meta">
                                                ...
                                                <p class="preview">初めまして！服のコーディネートで相談があります！ 私の体型に合った服は無いでしょうか？！</p>
                                            </div>
                                        </div>
                                    </li>
                    ...
                    <script >$(".messages").animate({ scrollTop: $(document).height() }, "fast");
                        ...
                        function newMessage() {
                            ...
                            $('<li class="sent"><img src="img/shop/cart-widget/02.jpg" alt="" /><p>' + message + '</p></li>').appendTo($('.messages ul'));
